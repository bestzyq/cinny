      ...
      content={
        ...
        >
          <Menu style={{ padding: config.space.S100 }}>
            <Box gap="100">
              <TooltipProvider
                tooltip={<BtnTooltip text={t('Editor.heading_1')} shortCode={`${modKey} + 1`} />}
                delay={500}
              >
                {(triggerRef) => (
                  <IconButton
              ...
              <TooltipProvider
                tooltip={<BtnTooltip text={t('Editor.heading_2')} shortCode={`${modKey} + 2`} />}
                delay={500}
              >
                {(triggerRef) => (
                  <IconButton
              ...
              <TooltipProvider
                tooltip={<BtnTooltip text={t('Editor.heading_3')} shortCode={`${modKey} + 3`} />}
                delay={500}
              >
                {(triggerRef) => (
                  <IconButton
        ...
        <Box className={css.EditorToolbar} alignItems="Center" gap="300">
          <>
            <Box shrink="No" gap="100">
              <MarkButton
                ...
                icon={Icons.Bold}
                tooltip={<BtnTooltip text={t('Editor.bold')} shortCode={`${modKey} + B`} />}
              />
              <MarkButton
                format={MarkType.Italic}
                icon={Icons.Italic}
                tooltip={<BtnTooltip text={t('Editor.italic')} shortCode={`${modKey} + I`} />}
              />
              <MarkButton
                format={MarkType.Underline}
                icon={Icons.Underline}
                tooltip={<BtnTooltip text={t('Editor.underline')} shortCode={`${modKey} + U`} />}
              />
              <MarkButton
                format={MarkType.StrikeThrough}
                icon={Icons.Strike}
                tooltip={<BtnTooltip text={t('Editor.strike_through')} shortCode={`${modKey} + S`} />}
              />
              <MarkButton
                format={MarkType.Code}
                icon={Icons.Code}
                tooltip={<BtnTooltip text={t('Editor.inline_code')} shortCode={`${modKey} + [`} />}
              />
              <MarkButton
                format={MarkType.Spoiler}
                icon={Icons.EyeBlind}
                tooltip={<BtnTooltip text={t('Editor.spoiler')} shortCode={`${modKey} + H`} />}
              />
            </Box>
          ...
          <Box shrink="No" gap="100">
            <BlockButton
              ...
              tooltip={<BtnTooltip text={t('Editor.block_quote')} shortCode={`${modKey} + '`} />}
            />
            <BlockButton
              format={BlockType.CodeBlock}
              icon={Icons.BlockCode}
              tooltip={<BtnTooltip text={t('Editor.block_code')} shortCode={`${modKey} + ;`} />}
            />
            <BlockButton
              format={BlockType.OrderedList}
              icon={Icons.OrderList}
              tooltip={<BtnTooltip text={t('Editor.ordered_list')} shortCode={`${modKey} + 7`} />}
            />
            <BlockButton
              format={BlockType.UnorderedList}
              icon={Icons.UnorderList}
              tooltip={<BtnTooltip text={t('Editor.unordered_list')} shortCode={`${modKey} + 8`} />}
            />
            <HeadingBlockButton />
          </Box>
          {canEscape && (
            <>
              ...
              <Box shrink="No" gap="100">
                <ExitFormatting
                  tooltip={
                    <BtnTooltip text={t('Editor.exit_formatting')} shortCode={`Escape, ${modKey} + E`} />
                  }
                />
              </Box>
            </>
          ...
          <Box className={css.MarkdownBtnBox} shrink="No" grow="Yes" justifyContent="End">
            <TooltipProvider
              align="End"
              tooltip={<BtnTooltip text={isMarkdown ? t('Editor.disable_markdown') : t('Editor.enable_markdown')} />}
              delay={500}
            >
              {(triggerRef) => (
                <IconButton
