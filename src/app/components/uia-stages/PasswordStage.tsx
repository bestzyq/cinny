...
export function PasswordStage({
  ...
  return (
    <Dialog>
      ...
      >
        <Box grow="Yes">
          <Text size="H4">{t('Components.PasswordStage.account_password', 'Account Password')}</Text>
        </Box>
      ...
      >
        <Box direction="Column" gap="400">
          <Text size="T200">
            {t('Components.PasswordStage.auth_instruction', 'To perform this action you need to authenticate yourself by entering you account password.')}
          </Text>
          <Box direction="Column" gap="100">
            <Text size="L400">{t('Components.PasswordStage.password', 'Password')}</Text>
                ...
                <Text size="T200">
                  <b>
                    {errorCode === ErrorCode.M_FORBIDDEN
                      ? t('Components.PasswordStage.invalid_password', 'Invalid Password!')
                      : `${errorCode}: ${error}`}
                  </b>
                </Text>
              </Box>
        ...
        <Button variant="Primary" type="submit">
          <Text as="span" size="B400">
            {t('Components.PasswordStage.continue', 'Continue')}
          </Text>
        </Button>
      </Box>
    </Dialog>
