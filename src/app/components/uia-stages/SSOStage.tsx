...
export function SSOStage({
  ...
  return (
    <Dialog>
      ...
      >
        <Box grow="Yes">
          <Text size="H4">{t('Components.SSOStage.sso_login', 'SSO Login')}</Text>
        </Box>
      ...
      >
        <Text size="T200">
          {t('Components.SSOStage.auth_instruction', 'To perform this action you need to authenticate yourself by SSO login.')}
        </Text>
        {errorCode && (
        ...
        {ssoWindow ? (
          <Button variant="Primary" onClick={handleSubmit}>
            <Text as="span" size="B400">
              {t('Components.SSOStage.continue', 'Continue')}
            </Text>
          </Button>
        ) : (
          <Button variant="Primary" onClick={handleContinue}>
            <Text as="span" size="B400">
              {t('Components.SSOStage.continue_with_sso', 'Continue with SSO')}
            </Text>
          </Button>
        )}
      </Box>
